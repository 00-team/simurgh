export const ProjectIcon = ({ size = 25 }) => (
    <svg
        stroke='currentColor'
        fill='currentColor'
        stroke-width='0'
...
export const DeleteIcon = ({ size = 25 }) => (
    <svg
        stroke='currentColor'
        fill='currentColor'
        stroke-width='0'
...
export const PersonIcon = ({ size = 25 }) => (
    <svg
        stroke='currentColor'
        fill='currentColor'
        stroke-width='0'
...
export const QrCodeIcon = ({ size = 25 }) => (
    <svg
        stroke='currentColor'
        fill='currentColor'
        stroke-width='0'
...
export const CalenderIcon = ({ size = 25 }) => (
    <svg
        stroke='currentColor'
        fill='currentColor'
        stroke-width='0'
...
export const LocationIcon = ({ size = 25 }) => (
    <svg
        stroke='currentColor'
        fill='currentColor'
        stroke-width='0'
...
export const PriceIcon = ({ size = 25 }) => (
    <svg
        stroke='currentColor'
        fill='currentColor'
        stroke-width='0'
